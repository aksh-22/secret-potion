          ...
          >
            {saveLoading ? (
              ...
              >
                <Starred
                  style={{ marginTop: -3 }}
                  fill={item?.is_save ? colors.starred : colors.downy}
                />
                <Text style={styles.postReactionText}>
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                item?.is_report
                                    ...
                                    : navigate(
                                          HomeRouteNames.REFLECTION_REPORT,
                                          {
                                              post_id: item?.id,
                                              index,
                                          }
...
export default memo(ReflectionPost);
